...
int main(){
  ...
  cout<<"*********DAFTAR MENU MAKANAN & MINUMAN BAKSO SUKSES***********"<<endl;
    ...
    cout<<"5. Kue kering         Rp. 3000"<<endl;
    cout<<"6. Mi ayam            Rp. 12000"<<endl;
    cout<<"7. Bakso beranak      Rp. 25000"<<endl;
    cout<<"--------------------------------------------------------------"<<endl;
    ...
    while(selesai==false){
      ...
      if (pilih[i]<=7){
        ...
        switch (pilih[i]){
            ...
            case 5 : menu[i]="Kue kering      "; harga[i]=3000; break;
            case 6 : menu[i]="Mi ayam         "; harga[i]=12000; break;
            case 7 : menu[i]="Bakso beranak   "; harga[i]=25000; break;
